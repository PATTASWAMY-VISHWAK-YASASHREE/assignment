...
## 2025-05-23 - Client-side Upload Validation
**Learning:** Users often drag unsupported files or large files, and waiting for server rejection is frustrating.
**Action:** Implement client-side validation (size & type) with clear error messages before initiating upload requests.
