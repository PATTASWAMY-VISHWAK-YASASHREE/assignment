...
async def save_dataset(file: UploadFile) -> DatasetUploadResponse:
    # Check file size efficiently by seeking the underlying file object
    # This avoids reading the entire file into memory (RAM) before processing.
    ...
    # Pass the file object directly to pandas to stream reading
