...
async def save_dataset(file: UploadFile) -> DatasetUploadResponse:
    # Check file size by seeking to the end to avoid memory exhaustion
    # from reading the entire file into memory.
    ...
    # Pass the underlying file object directly to pandas to avoid memory duplication.
