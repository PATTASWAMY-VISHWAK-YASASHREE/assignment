...
async def save_dataset(file: UploadFile) -> DatasetUploadResponse:
    # Optimize memory usage: Check file size directly from the underlying file object
    # instead of reading the entire content into a bytearray. This prevents
    # double-buffering (once in SpooledTemporaryFile, once in bytearray).
    ...
    # Pass the file object directly to pandas to enable streaming processing
    # where supported and avoid unnecessary memory duplication.
