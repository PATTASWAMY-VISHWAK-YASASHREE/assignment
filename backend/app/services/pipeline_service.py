...
def _filter_rare_classes(
    ...
    # Use value_counts instead of np.unique for significant speedup on categorical targets
    ...
    if rare:
        if drop_rare:
            ...
            # Crucially, reset the index of target to ensure alignment with df_features
